...
namespace ParametricDramDirectoryMSI
{
   ...
   {
      private:
		 //STACKED_LLC parameters
		#ifdef STACKED_LLC
		static StackedDramCacheCntlr* m_stacked_dram_cache;
		// = new StackedDramCacheCntlr(StackedDramSize/StackedPageSize/StackedAssoc, StackedAssoc, StackedBlockSize, StackedPageSize)
		#endif
      ...
      public:
		 ...
		 StackedDramCacheCntlr* m_dram_cache;
		 //bool is_last_level;
