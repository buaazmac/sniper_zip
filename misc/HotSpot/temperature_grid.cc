      ...
      switch (field) 
        ...
        case LCF_FLP:
          ...
          if (count < LCF_NPARAMS) {
			  ...
			  fatal2(i, model->width, get_total_width(model->layers[i].flp), model->height, get_total_height(model->layers[i].flp));
			//sprintf(test_str, "hahahaha\n");
			//  test_str = "hahahaha\n";
		 // model->width, get_total_width(model->layers[i].flp), model->height, get_total_height(model->layers[i].flp)
		    //fatal(test_str);
